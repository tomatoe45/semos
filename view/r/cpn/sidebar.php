<div class="menu_section">
  ...
  <ul class="nav side-menu">
    ...
    <li><a href="../dashboard.php"><i class="fa fa-dashboard"></i> Complaint History <span class="fa fa-angle-double-right"></span></a></li>
    <?php } ?>
    ...
    <li><a href="../complaint.php"><i class="fa fa-dashboard"></i> Complaint <span class="fa fa-angle-double-right"></span></a></li>
