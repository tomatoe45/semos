        ...
        <div class="page-title animate fadeInUp">
            ...
            <div class="row">
              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel ">
                  <div class="x_title">
                    <h2>BIOMEDICAL COMPLANTS REPORT </h2>
                    <div class="clearfix"></div>
                  </div>
                  <?php 
                    global $database;
                    ...
                    foreach ($g_allBio as $gb) {
                      ...
                      $tableContent = $tableContent . "<tr>"
                                                      ...
                                                      . "<td>". ($gb['res_date'] != '0000-00-00 00:00:00' ? $difference->format('%h hrs <br> %i minutes') : '...') ."</td>"
                        ...
                        <div class="col-md-4">
                              <div class="input-group">
                                ...
                                <div class="input-group-btn">
                                  ...
                                  <a href="rep_b_m_r.php" class="btn btn-primary"><i class="fa fa-refresh"></i></a>
                                </div>
                              </div>
                          </form>
                        </div>
